...
path_to_json=r'D:\sciebo\CTT_TTT Images\faulty json'
# path_to_json = r'C:\Users\alexs\Desktop\Git_Repo\TTT_ML\Json_files\German Steels - Atlas'
# path_to_json = r'C:\Users\aserafeim\Desktop\python\CCT_TTT_ML\Json_files\German Steels - Atlas'
...
for i in json_files:
    ...
    df_Temp_b = pd.concat([df_Temp_b, df_b],axis = 0)
...
df_Temp_b[elements]=df_Temp_b[elements].fillna(0)
df_Temp_k[elements]=df_Temp_k[elements].fillna(0)

df_Temp_b=df_Temp_b.fillna(False)


df_b2=test.keep_relevant(df_Temp_b,elements)
